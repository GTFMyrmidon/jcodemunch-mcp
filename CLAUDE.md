...
- **INDEX_VERSION:** 17
- **Tests:** 6162 passed, 7 skipped (1.108.189) + the KNOWN 12 local-ONNX `test_semantic_search` env failures (green in CI on all 4 ubuntu jobs — never read them as a regression)
- **Python:** >=3.10
...
**Open issues (2026-07-27): #375, #377 ONLY; ZERO open PRs.** Cleaned up in
