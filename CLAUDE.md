...
- **Older releases (1.108.173 and earlier):** see `CHANGELOG.md` — the authoritative version history (411 entries, 1.0.0 onward).
- **INDEX_VERSION:** 17
- **Tests:** 5806 passed, 7 skipped (1.108.176) + the KNOWN 12 local-ONNX `test_semantic_search` env failures (green in CI on all 4 ubuntu jobs — never read them as a regression)
- **Python:** >=3.10
