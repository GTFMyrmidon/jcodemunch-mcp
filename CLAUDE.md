...
- **Older releases (1.108.181 and earlier):** see `CHANGELOG.md`. The 1.108.181 entry ("uncommitted work is represented, per scope", #377 item 5), 1.108.180 ("unknown freshness stops collapsing into fresh", item 4) and 1.108.179 ("the subject has to hold still for the scan", item 6) are there in full.
- **INDEX_VERSION:** 17
