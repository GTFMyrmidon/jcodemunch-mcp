...
- **INDEX_VERSION:** 17
- **Tests:** 6213 passed, 7 skipped (1.108.194) + the KNOWN 12 local-ONNX `test_semantic_search` env failures (green in CI on all 4 ubuntu jobs — never read them as a regression)
- **Python:** >=3.10
